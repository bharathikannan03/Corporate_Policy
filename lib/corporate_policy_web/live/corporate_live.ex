defmodule CorporatePolicyWeb.CorporateLive do
  ...
  def render(assigns) do
    ...
    <Layouts.admin flash={@flash} current_user={@current_user} active_path={@active_path}>
      <div class="coming-soon-wrapper" id="corporate-coming-soon">
        <div class="coming-soon-icon">
          <.icon name="hero-building-office-2" class="w-16 h-16 text-blue-400" />
        </div>
        
        <h1 class="coming-soon-title">Corporate</h1>
