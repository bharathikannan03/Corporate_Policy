...
`
  ...
  var LiveSocket = class {
    ...
    /** @internal */
    transitionRemoves(elements2, view, callback2) {
  ...
  // node_modules/phoenix-colocated/corporate_policy/index.js
  var hooks = {};
  ...
  var RenewalsChart = {
    mounted() {
      ...
      this.chart = new auto_default(this.el, {
        type: "line",
        data: {
          labels,
          datasets: [
  ...
  var liveSocket = new LiveSocket("/live", Socket, {
    ...
    hooks: { RenewalsChart, DatePickerTrigger, PasswordToggle, ...hooks }
  });
