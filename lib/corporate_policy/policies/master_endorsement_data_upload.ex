defmodule CorporatePolicy.Policies.MasterEndorsementDataUpload do
  use Ecto.Schema
  import Ecto.Changeset

  schema "master_endorsement_data_uploads" do
  ...
  @doc false
  def changeset(master_endorsement_data_upload, attrs) do
    master_endorsement_data_upload
    |> cast(attrs, [
      ...
      :designation, :status, :is_register, :is_mail_send,
