defmodule CorporatePolicyWeb.Admin.AddPolicyLive do
  use CorporatePolicyWeb, :live_view

  alias CorporatePolicy.Policies
  alias CorporatePolicyWeb.Admin.Step1PolicyDetailsComponent
  alias CorporatePolicyWeb.Admin.Step2PolicyFeaturesComponent
  alias CorporatePolicyWeb.Admin.Step3SumInsuredComponent
  alias CorporatePolicyWeb.Admin.Step4DataUploadComponent
  alias CorporatePolicyWeb.Admin.Step5EscalationComponent
  alias CorporatePolicyWeb.Admin.Step6DocumentsComponent
  alias CorporatePolicyWeb.Admin.Step7CDStatementsComponent
