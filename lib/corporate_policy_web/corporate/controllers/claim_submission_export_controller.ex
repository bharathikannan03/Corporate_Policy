defmodule CorporatePolicyWeb.Corporate.ClaimSubmissionExportController do
  ...
  def export(conn, _params) do
    ...
    claims = Claims.list_claims_for_export(user, :corporate)
    ...
    |> put_resp_header(
      "content-disposition",
      "attachment; filename=claim-submissions-corporate.csv"
    )
    |> send_resp(200, csv)
  end
end
