...
config :corporate_policy, CorporatePolicyWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/corporate_policy_web/router\.ex$"E,
      ~r"lib/corporate_policy_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :corporate_policy, dev_routes: true
